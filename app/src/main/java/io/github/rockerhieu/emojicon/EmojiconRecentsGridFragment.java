...
public class EmojiconRecentsGridFragment extends EmojiconGridFragment implements EmojiconRecents {
    ...
    protected static EmojiconRecentsGridFragment newInstance(boolean useSystemDefault,OnEmojiconClickedListener listener) {
        ...
        fragment.setmOnEmojiconClickedListener(listener);
